...
namespace Suncor.LessonsLearnedMP.Web.Controllers
{
    ...
    {
        [CoverageExclude]
        public AdminController(LessonsLearnedMPEntities context):base(context)
        {
        }
        ...
        public IActionResult Index()
        {
            ...
            AdminViewData adminViewModel = new AdminViewData(this.HttpContext);
        ...
        public IActionResult EditReferenceValues(Enumerations.ReferenceType referenceType)
        {
            ...
            var model = new AdminViewData(this.HttpContext)
                {
